...
gsettings set org.gnome.desktop.interface gtk-theme "Yaru-$OMAKASEBLUE_THEME_COLOR-dark"
gsettings set org.gnome.desktop.interface icon-theme "Yaru-$OMAKASEBLUE_THEME_COLOR"
