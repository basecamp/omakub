...
if [ "$#" -gt 1 ]; then
  ...
  choice=$(gum choose "Agave" "Cascadia Mono" "Fira Mono" "JetBrains Mono" "Meslo" "> Change size" "<< Back" --height 8 --header "Choose your programming font")
fi

case $choice in
"Agave")
  set_font "Agave Nerd Font" "https://github.com/ryanoasis/nerd-fonts/releases/latest/download/Agave.zip" "ttf"
  ;;
"Cascadia Mono")
