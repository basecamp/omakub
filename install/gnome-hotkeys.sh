...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom1/ binding '<Shift><Control><Super>s'
...
gsettings set org.gnome.shell favorite-apps "['google-chrome.desktop', 'Alacritty.desktop', 'code_code.desktop', 'signal-desktop_signal-desktop.desktop', 'spotify.desktop', 'typora_typora.desktop', 'zoom-client_zoom-client.desktop', 'pinta_pinta.desktop', 'com.github.xournalpp.xournalpp.desktop', 'org.gnome.Nautilus.desktop', 'org.gnome.Settings.desktop']"
